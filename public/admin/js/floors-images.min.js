...
function floorsLoad(){var s=$("#images-greed"),e=[];s.html(""),e.push({name:"section_id",value:s.data("section")}),$.ajax({url:s.data("action"),method:"POST",data:e,success:function(e){var t=[],a=$('script[data-template="images"]').text().split(/\$\{(.+?)\}/g);$.each(e,function(e,o){t.floor_img=o.image_name,t.floor_title=o.image_code;o=a.map(render(t)).join("");console.log(o),s.append(o)})}})}function render(t){return function(e,o){return o%2?t[e]:e}}$(document).ready(function(){floorsLoad(),$("#floors-upload").on("submit",function(e){$("#floors-upload-btn").prop("Disabled"),e.preventDefault(),""==$("#image_file").val()?(alert("Choose File"),$("#floors-upload-btn").prop("enabled"),document.getElementById("floors-upload").reset()):$.ajax({url:$(this).attr("action"),method:"POST",data:new FormData(this),processData:!1,contentType:!1,cache:!1,dataType:"json",success:function(e){1!=e.success&&0!=e.success||$("#upload-messages").html(e.message),setTimeout(function(){$("#upload-messages").html("")},4e3),$("#floors-upload-btn").prop("Enabled"),document.getElementById("floors-upload").reset(),floorsLoad()}})})});