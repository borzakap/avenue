...
const banner = ['/*!\n',
    ' * Borzakap - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
...
function modules() {
    ...
    // Datepicker
    var jsDatepicker = gulp.src('./node_modules/js-datepicker/dist/*')
            .pipe(gulp.dest('./modules/datepicker'));
    // Bootstrap SCSS
    ...
    var dataTables = gulp.src([
        ...
        './node_modules/datatables.net-bs4/css/*.css'
            ...
            .pipe(gulp.dest('./modules/datatables'));
    // Font Awesome
