...
<div class="card shadow mb-4">
    ...
    <div class="collapse show card-body" id="collapseText">
        <?= form_open() ?>
        <?= view('App\Views\admin\discounts\_form') ?>
        <?= form_submit('update', lang('Admin.Form.Buttons.Save'), ['class' => 'btn btn-primary']) ?>
        <?= form_close() ?>    
    </div>
</div>
<div class="card shadow mb-4">
    ...
    <div class="collapse card-body" id="collapseImages">
        <?= form_open_multipart(route_to('discounts_files'), ['id' => 'images_upload']) ?>
        <?= view('App\Views\admin\discounts\_images_form') ?>
        <?= form_submit('upload', lang('Admin.Form.Buttons.Save'), ['class' => 'btn btn-primary', 'id' => 'upload-images-btn']) ?>
        <?= form_close() ?>    
