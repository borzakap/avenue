...
<div class="card shadow mb-4">
    ...
    <div class="collapse card-body" id="collapseImages">
        <?= form_open_multipart(route_to('layout_images_upload'), ['id' => 'images_upload']) ?>
        <?= view('App\Views\admin\layouts\_images_form') ?>
...
<div class="card shadow mb-4">
    ...
    <div class="collapse card-body" id="collapseSection">
        <?= form_open_multipart(route_to('layout_poligon_section'), ['id' => 'poligon_section']) ?>
        <?= view('App\Views\admin\layouts\_section_poligon_form') ?>
...
<div class="card shadow mb-4">
    ...
    <div class="collapse card-body" id="collapsePlan">
        <?= form_open_multipart(route_to('layout_poligon_plan'), ['id' => 'poligon_plan']) ?>
        <?= view('App\Views\admin\layouts\_genplan_poligon_form') ?>
