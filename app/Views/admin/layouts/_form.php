<div class="form-row">
    ...
    <div class="form-group col-md-12">
        <?php foreach ($languages as $language) : ?>
            <div class="languages-variants<?= ($default_language == $language) ? ' active' : '' ?>" data-language="<?= $language ?>">
                <?= form_label(lang('Layouts.Form.Labels.Title', ['language' => $language]), 'title_' . $language) ?>
    ...
    <div class="form-group col-md-12">
        <?php foreach ($languages as $language) : ?>
            <div class="languages-variants<?= ($default_language == $language) ? ' active' : '' ?>" data-language="<?= $language ?>">
                <?= form_label(lang('Layouts.Form.Labels.Description', ['language' => $language]), 'description_' . $language) ?>
    ...
    <div class="form-group col-md-12">
        <?php foreach ($languages as $language) : ?>
            <div class="languages-variants<?= ($default_language == $language) ? ' active' : '' ?>" data-language="<?= $language ?>">
                <?= form_label(lang('Layouts.Form.Labels.MetaTitle', ['language' => $language]), 'meta_title_' . $language) ?>
    ...
    <div class="form-group col-md-12">
        <?php foreach ($languages as $language) : ?>
            <div class="languages-variants<?= ($default_language == $language) ? ' active' : '' ?>" data-language="<?= $language ?>">
                <?= form_label(lang('Layouts.Form.Labels.Metadescription', ['language' => $language]), 'meta_description_' . $language) ?>
    ...
    <div class="form-group col-md-3">
        <div class="form-check">
            ...
            <?= form_label(lang('Layouts.Form.Labels.Balcon'), 'balcon') ?>
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        <div class="form-check">
            ...
            <?= form_label(lang('Layouts.Form.Labels.Advertise'), 'advertise') ?>
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        <div class="form-check">
            ...
            <?= form_label(lang('Layouts.Form.Labels.SoldOut'), 'sold_out') ?>
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        <div class="form-check">
            ...
            <?= form_label(lang('Layouts.Form.Labels.Publish'), 'publish') ?>
        </div>
    </div>
