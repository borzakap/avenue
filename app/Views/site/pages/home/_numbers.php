<section>
    <div class="facts-wrap thm-layer text-center position-relative overflow-hidden w-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-lg-3">
                    <div class="fact-box w-100">
                        <h2 class="mb-0"><span class="counter">1</span></h2>
                        <h4 class="mb-0"><?= lang('Site.Sections.Prefs.HousesCount') ?></h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-lg-3">
                    <div class="fact-box w-100">
                        <h2 class="mb-0"><span class="counter">18</span></h2>
